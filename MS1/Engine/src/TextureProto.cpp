...
namespace Azul
{
		...
		poTex(nullptr)
	{
		...
		// w1(7)
		this->width = mB.text_color.width;;
		this->height = mB.text_color.height;;

		if(mB.text_color.nComponent == textureData::TEXTURE_NCOMPONENT::NCOMPONENT_BGRA
		   || mB.text_color.nComponent == textureData::TEXTURE_NCOMPONENT::NCOMPONENT_RGBA)
		{
		...
		if(mB.text_color.nComponent == textureData::TEXTURE_NCOMPONENT::NCOMPONENT_RGB
		   || mB.text_color.nComponent == textureData::TEXTURE_NCOMPONENT::NCOMPONENT_RGBA)
		{
		...
		if(mB.text_color.nComponent == textureData::TEXTURE_NCOMPONENT::NCOMPONENT_BGR
		   || mB.text_color.nComponent == textureData::TEXTURE_NCOMPONENT::NCOMPONENT_BGRA)
		{
